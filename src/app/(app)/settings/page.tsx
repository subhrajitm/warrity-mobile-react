      ...
      <Tabs defaultValue="profile" className="w-full">
        ...
        <TabsContent value="profile">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your profile information that will be displayed to other users.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="appearance">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">Appearance settings content will be implemented here.</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
